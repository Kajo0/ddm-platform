...
class Svm2LvlSkinNoSkinSpec extends Specification {
    ...
    def "should #l_method #filtering_method - 1st=#first_lvl scatter data among files and perform correct classifications of training data"() {
        ...
        def idIndex = 0
        def labelIndex = 1
        def attributesAmount = 3
        def trainPercent = 40
        def classes = 2

        def sourceFile = Paths.get(getClass().getResource('/skin_noskin.txt').path)
        ...
        def strategies = [
                ...
                'all-but'              : 'fillEmptyButPercent=0.6;additionalClassesNumber=-1;additionalClassesPercent=0.05;emptyWorkerFill=1',
        ]
...
//        'none'                | 'convex_hull'
//        'none'                | 'only_with_svs'
        'none'           | 'just_random'         | '1.0'   | '0.1'    | 'false'   | 'false' | '0'    | '-1'
        'none'           | 'centroids'           | '1.0'   | '1.0'    | 'false'   | 'false' | '2'    | '-1'
        'none'           | 'centroids_per_class' | '1.0'   | '1.0'    | 'false'   | 'false' | '1'    | '-1'
        'none'           | 'just_random'         | '1.0'   | '0.1'    | 'false'   | 'true'  | '0'    | '-1'
        'none'           | 'centroids'           | '1.0'   | '1.0'    | 'false'   | 'true'  | '2'    | '-1'
