...
import pl.edu.pw.ddm.platform.algorithm.classification.svm2lvl.GlobalClassifier
import pl.edu.pw.ddm.platform.algorithm.classification.svm2lvl.Svm2Lvl
...
class Svm2LvlCovtypeSpec extends Specification {
    ...
    def "should #l_method #filtering_method - 1st=#first_lvl scatter data among files and perform correct classifications of training data"() {
        ...
        def idIndex = 0
        def labelIndex = 55
        def attributesAmount = 54
        def trainPercent = 40
        def classes = 7

        def sourceFile = Paths.get(getClass().getResource('/covtype.data').path)
        ...
        def strategies = [
                ...
                'all-but'              : 'fillEmptyButPercent=0.6;additionalClassesNumber=-5;additionalClassesPercent=0.05;emptyWorkerFill=1',
        ]
