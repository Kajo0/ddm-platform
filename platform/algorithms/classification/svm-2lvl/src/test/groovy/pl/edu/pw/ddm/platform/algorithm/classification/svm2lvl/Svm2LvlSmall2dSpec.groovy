...
class Svm2LvlSmall2dSpec extends Specification {
    ...
    def "should #l_method #filtering_method - 1st=#first_lvl scatter data among files and perform correct classifications of training data"() {
        ...
        def strategies = [
                ...
                'all-but'              : 'fillEmptyButPercent=0.6;additionalClassesNumber=-6;additionalClassesPercent=0.05;emptyWorkerFill=1',
        ]
